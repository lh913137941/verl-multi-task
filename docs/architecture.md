...
> 历史快照（2026-09-08）。本文下方版本、行号、profile-only 启动方式及“新增业务为空”
> 描述不代表当前工作区；当前开关、创建链和能力边界见 [README](../README.md)。
> 2026-09-16 的可选接入基于 VERL `f92febf5`，使用 `multitask.enabled=true`。
